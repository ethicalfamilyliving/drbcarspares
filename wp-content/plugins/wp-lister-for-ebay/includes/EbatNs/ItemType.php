...
class ItemType extends EbatNs_ComplexType
{
	...
	**/
	...
	// ***** BEGIN EBATNS PATCH *****
	/**
	 * @return ConditionDescriptorType[]|ConditionDescriptorType
	 * @param integer $index
	 **/
	function getConditionDescriptors($index = null)
	{
		if ($index !== null)
		{
			return $this->ConditionDescriptors[$index];
		}
		else
		{
	 ...
	 * @param integer $index
	 **/
	function setConditionDescriptors($value, $index = null)
	{
		if ($index !== null)
		{
			$this->ConditionDescriptors[$index] = $value;
		}
		else
		{
