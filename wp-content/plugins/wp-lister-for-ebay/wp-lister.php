...
define('WPLE_PLUGIN_VERSION', '3.5.11' );
...
class WPL_WPLister extends WPL_BasePlugin {
	...
	public function onWpAdminInit() {
		...
		if ( ProductWrapper::isProductsPage() ) {
			...
			wp_register_script( 'wple_profile_selector', self::$PLUGIN_URL.'js/classes/ProfileSelector.js' );
...
// Declare support for WCs Custom Order Tables
