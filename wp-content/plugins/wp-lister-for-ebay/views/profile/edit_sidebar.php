        ...
        text-align: center;
							...
							<div id="submitpost" class="submitbox">
								...
								<div id="major-publishing-actions">
									<div id="publishing-action">
										...
										<input type="hidden" name="return_to" value="<?php if ( !empty( $_GET['return_to'] ) ) echo sanitize_key( $_GET['return_to'] ) ; ?>" />
										<input type="hidden" name="listing_status" value="<?php if ( !empty( $_GET['listing_status'] ) ) echo sanitize_key($_GET['listing_status']); ?>" />
										<input type="hidden" name="s" value="<?php if ( !empty( $_GET['s'] ) ) echo sanitize_text_field($_GET['s']); ?>" />
							...
							<div id="wpl-custom_quantity_container">
                                ...
                                <div class="wple-field">
                                    ...
                                    <select id="wpl-auto_replenish" name="wpl_e2e_auto_replenish" class="select">
                                        <option value=""  <?php if ( @$item_details['auto_replenish'] != '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-ebay' ); ?></option>
                                        <option value="1" <?php if ( @$item_details['auto_replenish'] == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-ebay' ); ?></option>
                                    </select>
                                    <br class="clear" />
                                </div>
                    ...
                    <div class="postbox" id="SizeMapSettingsBox">
                        ...
                        <div class="inside">
                            ...
                            <input type="text" name="wpl_e2e_sizemap_field" id="wpl-text-sizemap_field" value="<?php echo @$item_details['sizemap_field']; ?>" class="text_input" />
                            <br class="clear" />
						...
						<div class="inside">
							...
							<div class="wple-field">
                                ...
                                <select id="wpl-text-with_additional_images" name="wpl_e2e_with_additional_images" title="Additional images" class=" required-entry select">
                                    <option value="0" <?php if ( @$item_details['with_additional_images'] == '0' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="1" <?php if ( @$item_details['with_additional_images'] == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Upload all images', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="2" <?php if ( @$item_details['with_additional_images'] == '2' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Upload first 24 images', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="3" <?php if ( @$item_details['with_additional_images'] == '3' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Upload only main image', 'wp-lister-for-ebay' ); ?></option>
                                </select>
                                <br class="clear" />
                                <p class="desc" style="display: none;">
						...
						<div class="inside">
                            <div class="wple-field">
                                ...
                                <select id="wpl-text-bestoffer_enabled" name="wpl_e2e_bestoffer_enabled" class=" required-entry select">
                                    <option value="1" <?php if ( @$item_details['bestoffer_enabled'] == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="0" <?php if ( @$item_details['bestoffer_enabled'] != '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-ebay' ); ?></option>
                                </select>
                                <br class="clear" />
                            </div>
						...
						<div class="inside">
                            ...
                            <div class="wple-field">
                                ...
                                <select id="wpl-text-schedule_time" name="wpl_e2e_schedule_time" title="Schedule listing" class=" required-entry select">
                                    <option value="" <?php if ( @$item_details['schedule_time'] == '' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'None', 'wp-lister-for-ebay' ); ?></option>
							...
							<div id="schedule_time_details_container">
								...
								<select id="wpl-text-schedule_days" name="wpl_e2e_schedule_days" class="required-entry select">
									<option value="0" <?php selected( @$item_details['schedule_days'], 0 ); ?>><?php _e( '+0 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="1" <?php selected( @$item_details['schedule_days'], 1 ); ?>><?php _e( '+1 day', 'wp-lister-for-ebay' ); ?></option>
									<option value="2" <?php selected( @$item_details['schedule_days'], 2 ); ?>><?php _e( '+2 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="3" <?php selected( @$item_details['schedule_days'], 3 ); ?>><?php _e( '+3 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="4" <?php selected( @$item_details['schedule_days'], 4 ); ?>><?php _e( '+4 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="5" <?php selected( @$item_details['schedule_days'], 5 ); ?>><?php _e( '+5 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="6" <?php selected( @$item_details['schedule_days'], 6 ); ?>><?php _e( '+6 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="7" <?php selected( @$item_details['schedule_days'], 7 ); ?>><?php _e( '+7 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="8" <?php selected( @$item_details['schedule_days'], 8 ); ?>><?php _e( '+8 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="9" <?php selected( @$item_details['schedule_days'], 9 ); ?>><?php _e( '+9 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="10" <?php selected( @$item_details['schedule_days'], 10 ); ?>><?php _e( '+10 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="11" <?php selected( @$item_details['schedule_days'], 11 ); ?>><?php _e( '+11 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="12" <?php selected( @$item_details['schedule_days'], 12 ); ?>><?php _e( '+12 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="13" <?php selected( @$item_details['schedule_days'], 13 ); ?>><?php _e( '+13 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="14" <?php selected( @$item_details['schedule_days'], 14 ); ?>><?php _e( '+14 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="15" <?php selected( @$item_details['schedule_days'], 15 ); ?>><?php _e( '+15 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="16" <?php selected( @$item_details['schedule_days'], 16 ); ?>><?php _e( '+16 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="17" <?php selected( @$item_details['schedule_days'], 17 ); ?>><?php _e( '+17 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="18" <?php selected( @$item_details['schedule_days'], 18 ); ?>><?php _e( '+18 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="19" <?php selected( @$item_details['schedule_days'], 19 ); ?>><?php _e( '+19 days', 'wp-lister-for-ebay' ); ?></option>
									<option value="20" <?php selected( @$item_details['schedule_days'], 20 ); ?>><?php _e( '+20 days', 'wp-lister-for-ebay' ); ?></option>
								</select>
								<br class="clear" />
						...
						<div class="inside">
                            ...
                            <div class="wple-field">
                                ...
                                <select id="wpl-text-autorelist_enabled" name="wpl_e2e_autorelist_enabled" class=" required-entry select">
                                    <option value="1" <?php if ( @$item_details['autorelist_enabled'] == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="0" <?php if ( @$item_details['autorelist_enabled'] != '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-ebay' ); ?></option>
                                </select>
                                <br class="clear" />
                            </div>
							...
							<select id="wpl-text-autorelist_condition" name="wpl_e2e_autorelist_condition" class=" required-entry select">
								<option value="" <?php if ( @$item_details['autorelist_condition'] == '' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'None', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistImmediately" <?php if ( @$item_details['autorelist_condition'] == 'RelistImmediately' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist immediately', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistAfterHours"  <?php if ( @$item_details['autorelist_condition'] == 'RelistAfterHours' ):  ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist after X hours', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistAtTimeOfDay" <?php if ( @$item_details['autorelist_condition'] == 'RelistAtTimeOfDay' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist at specific time of day', 'wp-lister-for-ebay' ); ?></option>
							</select>
							<br class="clear" />
						...
						<div class="inside">
                            ...
                            <div class="wple-field">
                                ...
                                <select id="wpl-text-sellingmanager_enabled" name="wpl_e2e_sellingmanager_enabled" class=" required-entry select">
                                    <option value="1" <?php if ( @$item_details['sellingmanager_enabled'] == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Yes', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="0" <?php if ( @$item_details['sellingmanager_enabled'] != '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-ebay' ); ?></option>
                                </select>
                                <br class="clear" />
                            </div>
							...
							<select id="wpl-text-AutomatedRelistingRule_Type" name="wpl_e2e_AutomatedRelistingRule_Type" class=" required-entry select">
								<option value="" <?php if ( @$item_details['AutomatedRelistingRule_Type'] == '' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'None', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistContinuously" <?php if ( @$item_details['AutomatedRelistingRule_Type'] == 'RelistContinuously' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist continuously', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistContinuouslyUntilSold" <?php if ( @$item_details['AutomatedRelistingRule_Type'] == 'RelistContinuouslyUntilSold' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist continuously until sold', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistOnceIfNotSold" <?php if ( @$item_details['AutomatedRelistingRule_Type'] == 'RelistOnceIfNotSold' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist once if not sold', 'wp-lister-for-ebay' ); ?></option>
							</select>
							<br class="clear" />
							...
							<select id="wpl-text-AutomatedRelistingRule_RelistCondition" name="wpl_e2e_AutomatedRelistingRule_RelistCondition" class=" required-entry select">
								<option value="" <?php if ( @$item_details['AutomatedRelistingRule_RelistCondition'] == '' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'None', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistImmediately" <?php if ( @$item_details['AutomatedRelistingRule_RelistCondition'] == 'RelistImmediately' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist immediately', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistAfterDaysHours" <?php if ( @$item_details['AutomatedRelistingRule_RelistCondition'] == 'RelistAfterDaysHours' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist after days / hours', 'wp-lister-for-ebay' ); ?></option>
								<option value="RelistAtSpecificTimeOfDay" <?php if ( @$item_details['AutomatedRelistingRule_RelistCondition'] == 'RelistAtSpecificTimeOfDay' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Relist at specific time of day', 'wp-lister-for-ebay' ); ?></option>
							</select>
							<br class="clear" />
