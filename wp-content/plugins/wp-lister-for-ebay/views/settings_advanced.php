						...
						<div class="inside">
                            ...
                            <div class="wple-field">
                                ...
                                <label for="wpl-option-skip_foreign_item_orders" class="text_label">
		                            ...
		                            <?php wplister_tooltip(__('If you have items listed on eBay which do not exist in WP-Lister, you can enable this option to skip orders which do not contain any known order line items.<br><br>Orders which contain both known and foreign items will still be created in WooCommerce.', 'wp-lister-for-ebay')) ?>
                                </label>
					...
					<div class="postbox" id="OrderTaxSettingsBox">
						...
						<div class="inside">
                            ...
                            <div class="wple-field">
                                ...
                                <input type="text" name="wpl_e2e_orders_fixed_vat_rate" id="wpl-text-orders_fixed_vat_rate" value="<?php echo $wpl_orders_fixed_vat_rate; ?>" class="text_input fixed_tax" />
                                <p class="desc fixed_tax" style="display: block;">
